...
class MainPage1 extends StatefulWidget {
  MainPage1({Key key, this.title}) : super(key: key);
...
class MainWidgetState extends State<MainPage1> with AutomaticKeepAliveClientMixin{
  ...
  {
    return new Text(
      entries[index] + "dadjkhdfjkhdksjhfgksdjfhgkdsfjhgkjsdfhgkdfjhgksdhfgjkhsdfgskdfhgkjdshfg",
          ...
          (Timer timer)
        {
          if (this.mounted) setState(
              ...
              if (currPers >= 0.99) {
                ...
                currRow +=1;
                currPers = 0.01;
                print("row" + currRow.toString());

              } else {
                currPers = currPers +0.01;
              }
  ...
  Widget buildRow(context, orientation, index) {
    ...
    [ new Expanded(
        child: new Column(
          ...
          children: <Widget>[titleText(index), titlsubTText(index), controlRow(index)],
        ),
      ),
      SizedBox.shrink(),
      SizedBox.shrink()
