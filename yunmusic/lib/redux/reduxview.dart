...
class ReduxView extends StatefulWidget {
  ReduxView({Key key, this.title}) : super(key: key);
...
class _MainViewState extends State<ReduxView> with AutomaticKeepAliveClientMixin{
  int _counter = 0;
  int _currentIndex =0;
